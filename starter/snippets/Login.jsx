// TEMPLATE — drop at admin/src/pages/Login.jsx.
// Change:
//   - the fallback companyName / tagline
//   - the icon ('restaurant' → whatever fits your domain)
//   - usePublicSettings() if your backend doesn't have a settings table; replace with hardcoded brand.

import { useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { useLogin } from '../api/queries'
// import { usePublicSettings } from '../api/queries'   // optional
      ...
      >
        <div className="text-center space-y-1">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-blue-600/20 border border-blue-500/30 mb-2">
            <span className="material-symbols-outlined text-blue-400" style={{ fontSize: 24 }}>dashboard</span>
          </div>
