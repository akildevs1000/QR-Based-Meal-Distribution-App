        ...
        <View style={styles.heroWrap}>
          ...
          <View style={styles.siteChip}>
            ...
            <Text style={styles.siteChipText}>
              Serving <Text style={styles.siteChipBold}>{site.name}</Text>
            </Text>
          </View>
        </View>
...
const SCAN_OUTER = 150
const SCAN_INNER = 132
...
const makeStyles = (colors, mode) => {
  ...
  headerBand: {
    paddingBottom: spacing.xl + spacing.md + 75,
  ...
  statValue: { fontSize: 28, fontWeight: '900', letterSpacing: -0.8, fontVariant: ['tabular-nums'] },
  statLabel: { color: colors.onSurfaceVariant, fontSize: 12, marginTop: 4, letterSpacing: 0.6, fontWeight: '600', textTransform: 'uppercase' },
